...
$sql_k .= " ORDER BY kategori_buku limit $posisi, $batas ";
    ...
    <tr>
       ...
       'index.php?include=kategori-buku&aksi=hapus&data=<?php echo 
...
$sql_jum .= " where kategori_buku LIKE '%$kata_kunci%'";
} 
    ...
    if($jum_halaman==0){
       ...
       if (isset($_GET["katakunci"])){
           ...
           if($halaman!=1){
              ...
              <a class='page-link' 
              href='index.php?include=kategori-buku&katakunci=$kata_kunci
           ...
           for($i=1; $i<=$jum_halaman; $i++){
            if ($i > $halaman - 5 and $i < $halaman + 5 ) {
               if($i!=$halaman){
                  echo "<li class='page-item'><a class='page-link' 
                  href='index.php?include=kategori-buku&katakunci
                  =$kata_kunci&halaman=$i'>
                  $i</a></li>";
               }else{
                  echo "<li class='page-item'>
            ...
            if($halaman!=$jum_halaman){
               ...
               echo "<li class='page-item'><a class='page-link' 
               href='index.php?include=kategori-buku&katakunci=
               $kata_kunci&halaman=$jum_halaman'>
               Last</a></li>";
            }
        }else{
          if($halaman!=1){
           ...
           for($i=1; $i<=$jum_halaman; $i++){
            if ($i > $halaman - 5 and $i < $halaman + 5 ) {
               if($i!=$halaman){
                   echo "<li class='page-item'><a class='page-link' 
                   href='index.php?include=kategori-buku&halaman=$i'>$i</a></li>";
               }else{
            ...
            if($halaman!=$jum_halaman){
               echo "<li class='page-item'><a class='page-link' 
               href='index.php?include=kategori-buku&halaman=$setelah'>
               »</a></li>";
               echo "<li class='page-item'><a class='page-link' 
               href='index.php?include=kategori-buku&
