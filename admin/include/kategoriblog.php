...
?>
    ...
    <section class="content">
            <div class="card">
              ...
              <div class="card-body">
              <div class="col-md-12">
                <form action="index.php?include=kategori-blog" method="post">
                    <div class="row">
                  ...
                  ?>
                    <tr>
                      ...
                      <td align="center">
                        ...
                        <a href="javascript:if(confirm('Anda yakin ingin menghapus data<?php echo $kategori_blog; ?>?'))window.location.href ='index.php?include=kategori-blog&aksi=hapus&data=<?php echo $id_kategori_blog;?>&notif=hapusberhasil'"class="btn btn-xs btn-warning"><i class="fas fa-trash"></i>Hapus</a>
                      </td>
                    </tr>
                    <?php $no++;}?>
                  </tbody>
