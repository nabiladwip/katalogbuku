<?php
    ...
    $sql_b .="ORDER BY `b`.`id_buku` LIMIT $posisi, $batas";
...
<div class="col-sm-12">
    <nav aria-label="Page navigation">
        <?php 
            $sql_jum = "SELECT `b`.`id_buku`, `b`.`judul`, `b`.`cover`, 
        ...
        <?php
                  ...
                  $setelah = $halaman+1;
                  if($halaman!=1){
                  echo "<li class='page-item'><a class='page-link' href='index.php?include=daftar-search-buku&halaman=1'>First</a></li>";
                  echo "<li class='page-item'><a class='page-link' href='index.php?include=daftar-search-buku&halaman=$sebelum'>«</a></li>";
                  }
                  for($i=1; $i<=$jum_halaman; $i++){
                  if ($i > $halaman - 5 and $i < $halaman + 5 ) {
                  if($i!=$halaman){
                  echo "<li class='page-item'><a class='page-link' href='index.php?include=daftar-search-buku&halaman=$i'>$i</a></li>";
                  }else{
                  ...
                  echo "<li class='page-item'><a class='page-link' href='index.php?include=daftar-search-buku&halaman=$setelah'>»</a></li>";
                  echo "<li class='page-item'><a class='page-link' href='index.php?include=daftar-search-buku&halaman=$jum_halaman'>Last</a></li>";
                  }
                  }?>
        </ul>
    </nav>
